...
export default function BrandPage() {
	return (
		<BasePage
			...
			description={
				<>
					Download Dreamy brand assets for use in your projects.{" "}
					<Link
						href="#guidelines"
			...
			<div id="guidelines" className="flex flex-col gap-8 text-sm">
				...
				<div className="flex flex-col gap-3">
					...
					<ul className="text-muted-foreground text-base flex flex-col gap-2 leading-relaxed">
						{[
							"Using Dreamy in the name of your product, service, or domain.",
							"Implying that Dreamy made, sponsors, or endorses your work.",
