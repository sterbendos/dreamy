...
export const metadata: Metadata = {
	title: "Changelog - Dreamy",
	description: "What's new in Dreamy",
	openGraph: {
		title: "Changelog - Dreamy",
		description: "Every update, improvement, and fix to Dreamy — documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in Dreamy">
