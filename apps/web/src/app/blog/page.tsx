...
export const metadata: Metadata = {
	title: "Blog - Dreamy",
	description:
		"Read the latest news and updates about Dreamy, the free and open-source video editor.",
	openGraph: {
		title: "Blog - Dreamy",
		description:
			"Read the latest news and updates about Dreamy, the free and open-source video editor.",
...
export default async function BlogPage() {
	...
	return (
		<BasePage
			title="Blog"
			description="Read the latest news and updates about Dreamy, the free and open-source video editor."
		>
